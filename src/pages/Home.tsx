        ...
        <div className="relative z-10 w-full py-20 md:py-28 lg:py-32">
          <div className="container mx-auto px-4">
            <div className="mb-12 text-center max-w-4xl mx-auto">
              ...
              {/* Main Heading */}
              <h1
                className="mb-6 text-5xl font-extrabold tracking-tight text-white sm:text-6xl md:text-7xl lg:text-8xl animate-fade-in"
                style={{ animationDelay: "100ms" }}
              >
                Freedom to <span className="text-gradient block sm:inline">Fitness</span>
              </h1>

              {/* Subheading */}
              <p
                className="mb-10 text-xl md:text-2xl text-white/85 max-w-2xl mx-auto leading-relaxed animate-fade-in"
                style={{ animationDelay: "200ms" }}
              >
                Access <span className="font-semibold text-white">20+ premium gyms</span> with one subscription. Work
                out anywhere, anytime, with complete flexibility.
              </p>
              ...
              >
                <Button
                  size="xl"
                  className="rounded-full px-10 py-6 text-lg font-semibold shadow-2xl shadow-primary/30 hover:scale-105 hover:shadow-primary/50 transition-all duration-300"
                ...
                <Button
                  variant="outline"
                  size="xl"
                  className="rounded-full px-10 py-6 text-lg font-semibold border-white/40 bg-white/10 text-white hover:bg-white/20 hover:text-white backdrop-blur-md hover:scale-105 transition-all duration-300"
              ...
              {/* Trust Badges */}
              <div
                className="mt-10 flex flex-wrap justify-center gap-6 animate-fade-in"
