...
const stats = [
  { label: 'Partner Gyms', end: 20, suffix: '+' },
  { label: 'Active Members', end: 1000, suffix: '+' },
  { label: 'Expert Trainers', end: 50, suffix: '+' },
  { label: 'Access Hours', end: 24, suffix: '/7' },
];
        ...
        >
          <div className="container mx-auto px-4">
            <div className="mb-12 text-center max-w-4xl mx-auto">
              ...
              {/* Main Heading */}
              <h1 className="mb-6 text-5xl font-extrabold tracking-tight text-white sm:text-6xl md:text-7xl lg:text-8xl animate-fade-in" style={{ animationDelay: '100ms' }}>
                Find Your{' '}
                <span className="text-gradient block sm:inline">Fitness</span>
              </h1>
              
              {/* Subheading */}
              <p className="mb-10 text-xl md:text-2xl text-white/85 max-w-2xl mx-auto leading-relaxed animate-fade-in" style={{ animationDelay: '200ms' }}>
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4 animate-fade-in" style={{ animationDelay: '300ms' }}>
                ...
                <Button variant="outline" size="xl" className="rounded-full px-10 py-6 text-lg font-semibold border-white/40 bg-white/10 text-white hover:bg-white/20 hover:text-white backdrop-blur-md hover:scale-105 transition-all duration-300" onClick={() => document.getElementById('gym-grid')?.scrollIntoView({ behavior: 'smooth' })}>
                  Explore Gyms
                </Button>
              </div>

              {/* Trust Badges */}
              <div className="mt-10 flex flex-wrap justify-center gap-6 animate-fade-in" style={{ animationDelay: '400ms' }}>
            ...
            <div className="flex flex-wrap justify-center gap-2">
              <Button 
                ...
                className={`rounded-full ${selectedCity !== 'All' ? 'border-white/30 bg-white/10 text-white hover:bg-white/20 hover:text-white' : ''}`}
              >
                All
              </Button>
              {cities.map(city => (
                <Button 
                  ...
                  className={`rounded-full ${selectedCity !== city ? 'border-white/30 bg-white/10 text-white hover:bg-white/20 hover:text-white' : ''}`}
                >
                  {city}
                </Button>
              ))}
